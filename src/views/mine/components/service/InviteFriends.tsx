        ...
        <PaperProvider>
                            ...
                            list2.map(item => {
                                return (
                                    <TouchableOpacity key={item.index} style={styles.mtlist} onPress={() =>{console.log(item.text);
                                        ...
                                        <Image source={item.img} style={[styles.mtImg, item.text == '新浪微博' ? { width: 68 } : null]} accessibilityLabel='图片'></Image>
            ...
            <ScrollView style={styles.parentbg}>
                <View style={[styles.heng, styles.title]}>
                    ...
                    <Image source={require('../../../../assets/images/tup/能量豆.png')} style={styles.iconBean} accessibilityLabel='图片'></Image>
                </View>
                <View style={styles.zhong}>
                    <ImageBackground source={require('../../../../assets/images/tup/yqh.jpg')} style={styles.xf} accessibilityLabel='背景'>
                        ...
                        {list1.map(item => {
                            return (
                                <View key={item.index} style={styles.list1Box}>
                                    <Image source={item.img} style={styles.list1Icon} accessibilityLabel='图片'></Image>
                                    <Text style={styles.h4}>{item.text}</Text>
                                </View>
                            )
                        })}
