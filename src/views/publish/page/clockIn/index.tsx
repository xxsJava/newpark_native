                ...
                <ScrollView style={styles.scrollStyle}>
                    <View style={styles.avatarView}>
                        <View style={styles.avatarFrame}>
                            <Image style={styles.avatarImage} source={require('../../../../assets/images/defaultheader.png')} accessibilityLabel='图片' alt="头像"></Image>
                        </View>
                        ...
                        <View style={styles.ruleView}>
                            <Image style={styles.ruleIcon} source={require('../../../../assets/images/help_icon.png')} accessibilityLabel='图片' alt="头像"></Image>
                    ...
                    <View style={styles.bgStyle}>
                        <View style={styles.timeView}>
                            <View style={styles.checkTimeView}>
                                ...
                                <View style={[styles.checkTextView,styles.notFinishedColor]}>
                                    <Image style={styles.checkIcon} source={require('../../../../assets/images/alimom/close_icon.png')} accessibilityLabel='图片' alt="头像"></Image>
                            ...
                            <View style={styles.checkTimeView}>
                                ...
                                <View style={[styles.checkTextView,styles.finishedColor]}>
                                    <Image style={styles.checkIcon} source={require('../../../../assets/images/alimom/correct1_icon.png')} accessibilityLabel='图片' alt="头像"></Image>
                        ...
                        <View style={styles.imageView}>
                            ...
                            <View style={styles.imageBg}>
                                ...
                                <Image style={styles.imageStyle} source={require('../../../../assets/gif/Animation2.gif')} accessibilityLabel='图片' alt="头像"></Image>
                            </View>
                            <Text allowFontScaling={false} style={styles.imageText}>考勤打卡</Text>
                        </View>
                        <View style={styles.addressView}>
                            <Image style={styles.addressIcon} source={require('../../../../assets/images/alimom/place-icon.png')} accessibilityLabel='图片' alt="头像"></Image>
                        ...
                        <TouchableOpacity activeOpacity={0.6} style={[styles.buttonStyle,styles.buttonColor1]}>
                            <Image style={styles.buttonIcon} source={require('../../../../assets/images/2.0x/takepicforheader.png')} accessibilityLabel='图片' alt="头像"></Image>
                            <Text allowFontScaling={false} style={styles.buttonText}>拍照打卡</Text>
                        </TouchableOpacity>
                        <View style={styles.promptView}>
                            <Image style={styles.promptImage} source={require('../../../../assets/gif/Animation1.gif')} accessibilityLabel='图片' alt="头像"></Image>
