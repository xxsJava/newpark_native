    ...
    return (
        <View style={styles.parentLevel}>
            <ScrollView style={styles.scrollStyle}>
                ...
                <Button onPress={() => navigate('RewardRoute')}>测试一下</Button>
            </ScrollView>
            <TouchableOpacity activeOpacity={0.7} style={styles.addbutstyle} onPress={() => navigate('RewardRoute')}>
                    <Image style={styles.addStyle} source={require('../../../../assets/images/3.0x/add_btn.png')}/>
            </TouchableOpacity>
>>>>>>> Stashed changes
        </View>
      </ScrollView>
