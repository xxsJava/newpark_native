...
import { View, Text, StyleSheet, SafeAreaView, Dimensions, Platform, Image, TextInput, KeyboardAvoidingView, ScrollView, Modal, Alert,TouchableOpacity } from "react-native";
                ...
                <KeyboardAvoidingView behavior="padding" enabled keyboardVerticalOffset={20} style={styles.modalBox}>
                    ...
                    <ScrollView style={styles.contentView}>
                        <View style={styles.contenStyle}>
                            <Avatar.Image size={80} style={styles.avatarStyle1} source={require('../../../../assets/images/defaultheader.png')}></Avatar.Image>
                            <View style={styles.cardView}>
                                ...
                                <View style={styles.bountyView}>
                                    ...
                                    <Button style={styles.buttonStyle1} labelStyle={styles.buttonText1} onPress={() => console.log('点击发布')}>发布悬赏</Button>
                                </View>
                            </View>
                        </View>
                    </ScrollView>
