    ...
    return(
        <View style={styles.parentView}>
            <Appbar.Header style={styles.headerStyle}>
                ...
                <Image style={styles.headerImage} source={require('../../../assets/images/order_kefu.png')} accessibilityLabel='图片'></Image>
            ...
            <ScrollView style={styles.scrollStyle}>
                <View style={styles.contentView}>
                    ...
                    <View style={styles.itemView}>
                        ...
                        <Image style={styles.moneyIcon} source={require('../../../assets/images/yuan_icon.png')} accessibilityLabel='图片'></Image>
                    </View>
                    <View style={styles.itemView}>
                    ...
                    <View style={styles.recipientView}>
                        ...
                        <Image style={styles.recipientIcon} source={require('../../../assets/images/phone_icon.png')} accessibilityLabel='图片'></Image>
                    </View>
